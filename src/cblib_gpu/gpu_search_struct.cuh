...
__device__ __forceinline__ void gpu_ss_descend(
...
__device__ __forceinline__ gpu_hist_ele_t gpu_ss_ascend(
...
__device__ __forceinline__ bool gpu_all_nodes_traversed(
        gpu_search_struct_t *__restrict__ ss)
{
    return ss->move_idx[ss->depth] == ss->move_counts[ss->depth];
}

__device__ __forceinline__ void gpu_traverse_to_next_child(
        gpu_search_struct_t *__restrict__ ss,
        gpu_board_t *__restrict__ board)
{
...
__device__ __forceinline__ bool gpu_traversal_complete(
        gpu_search_struct_t *__restrict__ ss)
{
