 ...
 */
__device__ __forceinline__ uint8_t gpu_mv_get_to(gpu_move_t mv)
{
 ...
 */
__device__ __forceinline__ uint8_t gpu_mv_get_from(gpu_move_t mv)
{
 ...
 */
__device__ __forceinline__ uint16_t gpu_mv_get_flags(gpu_move_t mv)
{
 ...
 */
__device__ __forceinline__ gpu_move_t gpu_mv_from_data(
 ...
 */
__device__ __forceinline__ bool gpu_mv_is_cap(gpu_move_t mv)
{
