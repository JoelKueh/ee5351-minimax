...
#define CB_INVALID_MOVE ((cb_move_t)0b0110111111111111)
#define CB_INIT_STATE ((cb_hist_ele_t) { HIST_INIT_BOARD_STATE, CB_INVALID_MOVE })

#define CB_MV_TO_MASK   UINT16_C(0x3F)
#define CB_MV_FROM_MASK UINT16_C(0x3F << 6)
#define CB_MV_FLAG_MASK UINT16_C(0xF << 12)
